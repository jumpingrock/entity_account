...
@Component({
  selector: 'app-entity-account-inquiry-first',
  templateUrl: './entity-account-inquiry-first.component.html',
  styleUrls: ['./entity-account-inquiry-first.component.css']
})
export class EntityAccountInquiryFirstComponent extends CRUDComponent implements OnInit {
total_record = 0;
    total_acc_record = 0;
